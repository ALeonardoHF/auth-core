    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "PermissionsJson", "Role" },
                values: new object[,]
                {
                    { 1, "{\"users\":[\"read\",\"create\",\"update\",\"delete\"],\"orders\":[\"read\",\"create\",\"update\",\"delete\"]}", "Admin" },
                    { 2, "{\"users\":[\"read\"],\"orders\":[\"read\",\"update\"]}", "Helper" },
                    { 3, "{\"orders\":[\"read\",\"create\"]}", "Client" }
                });
